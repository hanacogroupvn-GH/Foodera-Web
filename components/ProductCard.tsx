      ...
      <div className="flex flex-wrap gap-1.5 mt-3">
        {Object.entries(localizedProduct.filters).map(([key, value]) => {
          ...
          return (
            <span 
              key={key} 
              className="px-2 py-0.5 bg-gray-50 text-gray-500 text-[9px] font-black uppercase tracking-widest rounded-md border border-gray-100 group-hover:border-foodera-lime/30 group-hover:bg-foodera-lime/5 transition-colors"
            >
              {displayValue}
            </span>
          );
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex-grow flex flex-col">
        <h3 className="text-xl font-black text-gray-900 mb-2 group-hover:text-foodera-forest transition-colors leading-tight">
        ...
        <div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between">
          <span className="flex items-center gap-1.5 text-[10px] font-black text-gray-400 uppercase tracking-widest">
            <CheckCircle size={12} className="text-foodera-lime" /> {copy.exportQuality}
          </span>
          <span className="flex items-center gap-1 text-sm font-black text-foodera-forest transition-all group-hover:gap-2">
