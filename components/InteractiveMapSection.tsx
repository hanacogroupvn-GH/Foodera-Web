  ...
  const copy =
    locale === 'zh'
      ...
      ? {
          ...
          sectionBadge: 'Bản đồ Tương tác Nông sản',
          defaultTitle: 'Bản đồ Vùng trồng Nông sản Xuất khẩu Việt Nam',
          defaultSubtitle: 'Khám phá trực quan 6 vùng sinh thái nông nghiệp, đặc tính thổ nhưỡng, năng suất mùa vụ và tiêu chuẩn canh tác cho từng mặt hàng nông sản chủ lực (Lúa gạo, Cà phê, Hạt điều, Hồ tiêu, Sầu riêng, Dưa hấu).',
